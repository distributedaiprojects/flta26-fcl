...
client_label_config =  {0: {0:  [0, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        ...
                        20: {0: [2, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        30: {0: [2, 8], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        40: {0: [0, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
