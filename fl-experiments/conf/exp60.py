...
client_label_config = {
    ...
    5: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
    10: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
    15: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
    50: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
    55: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
    60: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
    65: {0: [0, 1],1: [1, 2],2: [2, 3],3: [3, 4],4: [4, 5],5: [5, 6],6: [6, 7],7: [7,8],8: [8,9],9: [9,0]},
}
