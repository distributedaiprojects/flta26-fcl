...
client_label_config =  {0: {0: [1,4], 1: [9,2], 2: [8,1], 3: [4,6], 4: [2,9], 5: [6,8], 6: [1,2], 7: [4,9], 8: [6,1], 9: [8,2]}, 
                        ...
                        40: {0: [3,5], 1: [0,7], 2: [8,1], 3: [4,6], 4: [2,9], 5: [6,8], 6: [1,2], 7: [4,9], 8: [6,1], 9: [8,2]}, 
                        50: {0: [1,4], 1: [9,2], 2: [8,1], 3: [4,6], 4: [2,9], 5: [6,8], 6: [1,2], 7: [4,9], 8: [6,1], 9: [8,2]}, 
                        60: {0: [1,4], 1: [9,2], 2: [8,1], 3: [4,6], 4: [2,9], 5: [6,8], 6: [1,2], 7: [4,9], 8: [6,1], 9: [8,2]}, 
                        70: {0: [1,4], 1: [9,2], 2: [8,1], 3: [4,6], 4: [2,9], 5: [6,8], 6: [1,2], 7: [4,9], 8: [6,1], 9: [8,2]}, 
                        80: {0: [1,4], 1: [9,2], 2: [8,1], 3: [4,6], 4: [2,9], 5: [6,8], 6: [1,2], 7: [4,9], 8: [6,1], 9: [8,2]}}
