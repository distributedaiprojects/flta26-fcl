...
client_label_config =  {0: {0:  [0, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        10: {0: [2, 8], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [3,9], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        20: {0: [7,9], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        30: {0: [0, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [5, 6], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        40: {0: [1,2], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [3, 4]}, 
                        50: {0: [0, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        60: {0: [3,7], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        70: {0: [9,2], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [7, 5], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
