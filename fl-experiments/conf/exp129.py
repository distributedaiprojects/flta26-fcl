...
client_label_config =  {0: {0: [0, 1], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        10: {0: [0, 9], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        20: {0: [0, 9], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        30: {0: [4, 8], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        40: {0: [8, 9], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        50: {0: [2, 9], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        60: {0: [0, 5], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
                        70: {0: [5, 7], 1: [3, 6], 2: [4, 9], 3: [3, 9], 4: [5, 9], 5: [2, 4], 6: [6, 9], 7: [1, 3], 8: [1, 7], 9: [6, 8]}, 
